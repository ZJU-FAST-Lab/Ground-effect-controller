...
The rotor speeds require closed-loop control; however, we do not implement this control for each motor individually. Instead, we apply closed-loop control to the combined acceleration generated by all rotors along **${\bm{z}}_B$**. The control method for rotor speed is:
