...
| ------------------------------------------------------------ | ---------------------------------------------- | ---------------------------------------------- | ------------------------------------------ | ------------------------------------------------- | ------------------------------------------------ |
| ${\bf{N}_{base}}\left( 1 \right)$                            | -                                              | -                                              | $\uparrow -0.6640^{\ref{subsec:getorque}}$ | -                                                 | $\uparrow +0.4703^{\ref{subsec:rotors_force}}$   |
| ${\bf{N}_{base}}\left( 2 \right)$                            | $\uparrow +0.8245^{\ref{subsec:bodytorque}}$   | -                                              | -                                          | -                                                 | -                                                |
| ${\bf{N}_{base}}\left( 3 \right)$                            | -                                              | -                                              | -                                          | -                                                 | -                                                |
| ${\bf{N}_{base}}\left( 4 \right)$                            | -                                              | $\uparrow +0.9251^{\ref{subsec:bodytorque}}$   | -                                          | -                                                 | -                                                |
